...
public class ReferenceMasterService {
    ...
    public Object getReferenceData(ReferenceCategory category) {

        return switch (category) {
            case POLICY_TERM -> repository.getPolicyTerms();
            case PAYMENT_FREQUENCY -> repository.getPaymentFrequencies();
        };
    }
}